...
export function renderProfessorLayout(content, currentPage = 'dashboard') {
    ...
    document.title = `Professor Dashboard - GroupSync`;
    return layout;
}

function renderSidebar(user, currentPage) {
    const navItems = [
        { id: 'dashboard', name: 'Dashboard', icon: '📊', path: '/professor/dashboard.html' },
        { id: 'courses', name: 'Course Management', icon: '📚', path: '/professor/course-management.html' },
        { id: 'analytics', name: 'Group Analytics', icon: '📈', path: '/professor/group-analytics.html' },
        { id: 'evaluation', name: 'Student Evaluation', icon: '🎓', path: '/professor/student-evaluation.html' },
        { id: 'reports', name: 'PDF Reports', icon: '📄', path: '/professor/pdf-report.html' }
    ];
        ...
        <aside id="sidebar" class="fixed inset-y-0 left-0 w-64 bg-white shadow-lg transform -translate-x-full md:translate-x-0 transition-transform duration-300 z-30">
            <div class="flex flex-col h-full">
                <div class="flex items-center justify-center h-16 bg-blue-600">
                    ...
                    <span class="ml-2 text-xs text-blue-200">Professor</span>
                </div>
                ...
                <div class="p-4 border-t">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3 flex-1">
                            <p class="text-sm font-medium text-gray-700">Prof. ${user.first_name || 'Professor'}</p>
        ...
        <nav class="bg-white shadow-sm">
            <div class="px-4 py-3">
                <div class="flex justify-between items-center">
                    <h2 class="text-2xl font-semibold text-gray-800">Professor Dashboard</h2>
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="flex items-center space-x-2">
                            <span class="text-sm text-gray-600">Prof. ${user.first_name || 'Professor'}</span>
...
export function initProfessorLayout() {
    // Mobile menu toggle
...
export default { renderProfessorLayout, initProfessorLayout };